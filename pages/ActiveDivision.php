      ...
      <h2>Active Division</h2>
        <div class="right-wrapper pull-right">
          <ol class="breadcrumbs">
            ...
            <li><span>Active Division</span></li>
                    ...
                    <form id="Active-Division-form2">
                      <div style="display: none;" id="Nxt_slot">
                                ...
                                <div class="form-group col-sm-2">
                                  <br/>
                                  <label for="semester" class="control-label">For Division-wise </label>
                                </div>
                              </center>
                                ...
                                <div class="form-group col-sm-1">                        
                                  <br/>
                                  <label for="course-id" class="control-label">Division</label>
                              </div>
...
function display_ADForm() 
{
  ...
  } else 
  {
    ...
    y.innerHTML="Add New Active Division";
...
<!-- add new Active Division modal End-->


<!-- Update new Active Division modal Start-->
                    ...
                    <form id="Active-Division-form2_2">
                      ...
                      <div style="display: none;" id="Nxt_slot_2">
                                ...
                                <div class="form-group col-sm-1">
                                  <br/>
                                  <label for="academic-year" class="control-label">Division</label>
                                </div>
                                ...
                                <div class="form-group col-sm-10">
                                  ...
                                  <select id="roll-no11_2" name="roll_no11_2" class="form-control">
                                          <option value="">Select Roll No</option>
                                          <option>small</option>
                                          <option>medium</option>
                                          <option>large</option>
...
function close_updteAD()
{
  ...
  var e = document.getElementById("Nxt_slot_2");
    d.innerHTML="Add New Active Division";
