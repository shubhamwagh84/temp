					...
					<div id="userbox" class="userbox">
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								<li class="divider"></li>
								<li>
									<a role="menuitem" tabindex="-1" href="#" data-toggle="modal" data-target="#changePassword" data-whatever="@fat"><i class="fa fa-user"></i> Change Password</a>
								</li>
								<li>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="#" method="POST" id="change-password-form1">
      ...
      <div class="modal-footer">
        ...
        <input type="submit" class="btn btn-primary" id="add-student" value="Add">
      </div>
      </form>
    </div>
  </div>
